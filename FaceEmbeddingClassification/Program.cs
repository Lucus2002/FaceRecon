...
namespace FaceEmbeddingsClassification
{
    class Program
    {
        ...
        static void Main()
        {
            ...
            //var imagePath= @"C:\App&Stuffs\Programming\SchoolManagementApp\SchoolManagementApp\wwwroot\images\1_Lay Phyu";
            ...
            foreach (var score in scores)
            {
                ...
                if (similarity > currenthighestscore)
                {
                    currenthighestscore = similarity;

                    filename = Path.GetFileName(score);
                }
